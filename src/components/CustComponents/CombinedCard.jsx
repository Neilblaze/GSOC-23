...
function CombinedCard(props) {
  ...
  switch (props.type) {
    ...
    case "card2":
      ...
      bgClass =
        "border-green-400 bg-green-300 bg-opacity-30 hover-gradient-green";
      break;
    case "card2b":
    ...
    case "card3":
      classesName = "w-64 rounded border-yellow-400";
      bgClass =
        "bg-violet-400 bg-opacity-30 transform transition duration-500 scale-105";
      break;
    case "card4":
      classesName = "w-128 rounded-xl border-emerald-400";
      bgClass =
        "bg-green-200 bg-opacity-30 transform transition duration-500 scale-125";
      break;
    case "card5":
