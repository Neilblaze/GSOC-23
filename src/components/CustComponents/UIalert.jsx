...
function UIalert({ gesture, finger_locx, loaded }) {
  ...
  if (!loaded) {
    ...
    // status is "no" and loaded is "true"
    return (
      <div
        className="absolute top-0 mx-auto w-screen flex items-center justify-center mt-2"
        role="alert"
      >
        <div>
    ...
    // status is "GRAB" and loaded is "true"
    return (
    ...
    // display all other status in blue background & corresponding messages
    return (
      <div className="absolute top-0 mx-auto w-screen flex items-center justify-center mt-2">
        <div
          className="flex items-center text-white text-sm font-bold bg-blue-600 px-4 py-3 rounded"
          role="alert"
        >
          <svg
